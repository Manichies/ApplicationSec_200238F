...
namespace ApplicationSec_200238F
{
    ...
    public class GoogleAPI : WebService
    {

        [WebMethod]
        public PairingInfo Pair(string appName, string secretCode)
        {
            var tfa = new TwoFactorAuthenticator();
            var setupInfo = tfa.GenerateSetupCode(appName, secretCode, 300, 300);
